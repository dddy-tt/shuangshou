...
/* 当前调试接线：左手五路全部上报；未接入通道的悬空跟随现象允许保留。 */
#define FLEX_LEFT_L1_ENABLED  1U
#define FLEX_LEFT_L2_ENABLED  1U
#define FLEX_LEFT_L3_ENABLED  1U
#define FLEX_LEFT_L4_ENABLED  1U
#define FLEX_LEFT_L5_ENABLED  1U
